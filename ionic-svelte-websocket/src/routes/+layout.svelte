<script>
    ...
    //     broadcaster: "pusher",
    //     key: "DEXDc4wbhS9nSsJGuK2nm7yb",
    //     // wsHost: window.location.hostname,
    //     authEndpoint: "http://quasarsocket.test/broadcasting/auth",
    //     wsHost: "quasarsocket.test",
    //     cluster: "mt1",
    //     wsPort: 80,
    //     forceTLS: false,
    //     disableStats: true,
    ...
    // window.Echo.channel(`testquasarchannel`).listen("BroadcastNotificationCreated", (e) => {
    //     console.log(123);
    // });
    // window.Echo.channel(`testquasarchannel`).notification((notification) => {
